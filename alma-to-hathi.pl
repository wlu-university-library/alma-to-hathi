...
@dir_list = ("leyburn", "telford");
#@dir_list = ("arch", "burns", "bapst", "erc", "geo", "law", "swk", "tml", "onl_bks");
#Serials directory
#@dir_list = ("arch_ser", "burns_ser", "bapst_ser", "erc_ser", "geo_ser", "law_ser", "swk_ser", "tml_ser", "onl_ser");
#@dir_list = ("tml");
...
for ($d = 0; $d <= $#dir_list; $d++)
{
     ...
     $path_xml = sprintf("%s%s%s", "/opt/hathi/", $dir_list[$d], "/xml");
